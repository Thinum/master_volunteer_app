...
const organisations = [
  { id: 1, orgName: 'Tech Aid Association', location: { lat: 48.2082, lon: 16.3738 }, profilePicture: 'https://logotypes.dev/Protopie?variant=glyph&version=color', createdAt: '2023-06-15T00:00:00Z', body: 'Helping underprivileged communities learn coding skills.', deactivated: false, orgContacts: [users[0], users[1]], members: [users[0], users[1], users[2]], category: 'Technology', tags: ['coding', 'programming', 'mentorship', 'youth', 'digital skills'] },
  { id: 2, orgName: 'Green Future Org', location: { lat: 48.3069, lon: 14.2858 }, profilePicture: 'https://logotypes.dev/Clearscope?variant=glyph&version=color', createdAt: '2023-09-20T00:00:00Z', body: 'Dedicated to sustainability and green innovation.', deactivated: false, orgContacts: [users[2]], members: [users[0], users[2], users[3]], category: 'Environment', tags: ['sustainability', 'climate', 'renewable energy', 'eco projects'] },
  { id: 3, orgName: 'Community Connect', location: { lat: 47.0707, lon: 15.4395 }, profilePicture: 'https://logotypes.dev/Contentful?variant=glyph&version=color', createdAt: '2023-10-01T00:00:00Z', body: 'Connecting volunteers with local social projects.', deactivated: false, orgContacts: [users[3]], members: [users[0], users[1], users[3], users[4]], category: 'Community', tags: ['volunteering', 'local projects', 'non-profit', 'social impact'] },
  { id: 4, orgName: 'Education for All', location: { lat: 47.8095, lon: 13.055 }, profilePicture: 'https://logotypes.dev/Feedly?variant=glyph&version=color', createdAt: '2024-02-10T00:00:00Z', body: 'Providing access to quality education worldwide.', deactivated: false, orgContacts: [users[4]], members: [users[0], users[4], users[5]], category: 'Education', tags: ['schools', 'learning', 'scholarships', 'children', 'global'] },
  { id: 5, orgName: 'HealthFirst Initiative', location: { lat: 48.1486, lon: 17.1077 }, profilePicture: 'https://logotypes.dev/Googlefonts?variant=glyph&version=color', createdAt: '2023-05-11T00:00:00Z', body: 'Promoting healthy lifestyles and preventive medicine.', deactivated: false, orgContacts: [users[5]], members: [users[3], users[5]], category: 'Health', tags: ['wellness', 'fitness', 'nutrition', 'mental health', 'prevention'] },
  { id: 6, orgName: 'Cultural Bridges Foundation', location: { lat: 46.0569, lon: 14.5058 }, profilePicture: 'https://logotypes.dev/Instacart?variant=glyph&version=color', createdAt: '2023-07-22T00:00:00Z', body: 'Encouraging cultural exchange and diversity awareness.', deactivated: false, orgContacts: [users[6]], members: [users[1], users[6]], category: 'Culture', tags: ['diversity', 'exchange programs', 'international', 'inclusion'] }
];
