...
export const MOCK_USERS: User[] = [
  {
    ...
    skills: ['Teamwork', 'Communication', 'Mentoring'],
    interests: ['Teaching', 'Environmental Work', 'Event Support'],
  ...
  },
  {
    ...
    interests: ['Fundraising', 'Event Support'],
    joinedAt: new Date(2024, 2, 10, 2, 30),
    isActive: true,
  },
  {
    ...
    interests: ['Teaching', 'Social Media'],
    joinedAt: new Date(2024, 2, 10, 2, 30),
    isActive: true,
  },
  {
    ...
    interests: ['Event Support', 'Fundraising'],
    joinedAt: new Date(2024, 2, 10, 2, 30),
    isActive: true,
  },
  {
